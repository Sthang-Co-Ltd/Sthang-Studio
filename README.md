...
- **Local rendering operations**: Caption preview and captioned-video rendering are local operations. Studio does not upload rendered video frames or the resulting captioned MP4 as part of that rendering process. Caption generation/regeneration has a separate data flow involving normalized audio and related context, as described in the Gemini and Contributor sections.
