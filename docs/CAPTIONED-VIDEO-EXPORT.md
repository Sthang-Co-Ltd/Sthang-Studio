...
local FFmpeg and libass backend used for final MP4 export. This guarantees that
Khmer complex shaping, line breaks, relative font size, outlines, drop shadows,
and bottom positioning match the final export frame-for-frame.
